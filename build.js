...
const output = `// THIS FILE IS AUTO-GENERATED BY build.js
const studyData = ${JSON.stringify(studyData, null, 2)};
const moduleContents = ${JSON.stringify(moduleContents, null, 2)};
`;

fs.writeFileSync(path.join(__dirname, 'bundle_data.js'), output);
console.log("Successfully built bundle_data.js!");
